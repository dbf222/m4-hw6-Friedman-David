...
if (toppings === ""){
  ...
  var toppingsExtra = toppings. split(",");
  pizza.toppings = toppingsExtra

  var toppingsCharge = (toppingsFee * toppingsExtra.length);

  pizza.cost += toppingsCharge
